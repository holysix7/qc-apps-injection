    ...
    <Container>
      ...
      <View style={{flex: 1, backgroundColor: '#dfe0df'}}>
        ...
        >
          ...
          {loading ? <View style={{alignItems: 'center', borderTopWidth: 1, borderTopColor: 'gray', paddingVertical: 10}}><Text style={{fontSize: 12, fontWeight: 'bold'}}>STATUS MESIN</Text></View> : null}
