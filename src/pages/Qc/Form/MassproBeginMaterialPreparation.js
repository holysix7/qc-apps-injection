					...
					<View style={{flex: 1, height: 100, backgroundColor: '#F5F5DC', borderWidth: 0.3, flexDirection: 'column'}}>
						...
						<View style={{flexDirection: 'row'}}>
							<View style={{borderWidth: 0.3, height: 65, alignItems: 'center', width: "50%", backgroundColor: '#F5F5DC'}}>
								...
								<Text style={{fontWeight: 'bold', fontSize: 11}}>Masspro Begin Material Preparation</Text>
						...
						<ScrollView style={{flex: 1}}>
							<View style={{paddingTop: 20, flexDirection: 'row'}}>
								<View style={{padding: 10, width: "50%"}}>
									<Text>Material By Standard</Text>
								</View>
								<View style={{padding: 10, width: "6%"}}>
									<Text>:</Text>
								</View>
								<View style={{padding: 4, width: "29%"}}>
									<TextInput value={material} onChangeText={(value) => setMaterial(value)} style={{borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 30}} placeholder="Type Here..." />
								</View>
								<View style={{padding: 4, width: "15%"}}>
									<View style={{borderWidth: 0.5, borderRadius: 25, height: 30, justifyContent: 'center', paddingLeft: 5}}>
										<SelectPicker onValueChange={(value) => setConditionMaterial(value)} 
											items={[
												{label: "OK", value: "OK"},
												{label: "NG", value: "NG"}
											]}
							...
							<View style={{paddingTop: 20, flexDirection: 'row'}}>
								<View style={{padding: 10, width: "50%"}}>
									<Text>Temperatur Hopper</Text>
								</View>
								<View style={{padding: 10, width: "6%"}}>
									<Text>:</Text>
								</View>
								<View style={{padding: 4, width: "29%"}}>
									<TextInput keyboardType='numeric' value={hopper} onChangeText={(value) => setHopper(value)} style={{borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 30}} placeholder="Type Here..." />
								</View>
								<View style={{padding: 4, width: "15%"}}>
									<View style={{borderWidth: 0.5, borderRadius: 25, height: 30, justifyContent: 'center', paddingLeft: 5}}>
										<SelectPicker onValueChange={(value) => setConditionHopper(value)} 
											items={[
												{label: "OK", value: "OK"},
												{label: "NG", value: "NG"}
											]}
