import {Image, View, StyleSheet, Picker, StatusBar, ScrollView, TextInput, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard} from 'react-native';
...
const MassproBeginMaterialPreparation = () => {
				...
				<View style={{flex: 1, height: 100, backgroundColor: '#F5F5DC', borderWidth: 0.3, flexDirection: 'column'}}>
					...
					<View style={{paddingTop: 20, flexDirection: 'row'}}>
						<View style={{padding: 10, width: "50%"}}>
							<Text>Material Sesuai Standard</Text>
						</View>
					...
					<View style={{paddingTop: 20, flexDirection: 'row'}}>
						...
						<View style={{paddingTop: 11, paddingLeft: 5, width: "21%"}}>
							<Text>Start From:</Text>
						</View>
						<View style={{paddingTop: 5, paddingRight: 5, width: "23%"}}>
							<Text>2020-10-07 08:52:00</Text>
						</View>
					</View>
					<View style={{paddingTop: 20, flexDirection: 'row'}}>
						<View style={{padding: 10, width: "50%"}}>
