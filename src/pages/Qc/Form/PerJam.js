                                ...
                                <TouchableOpacity>
                                    ...
                                    <View style={{paddingTop: 20, flexDirection: 'row'}}>
                                        ...
                                        <View style={{padding: 4, width: "50%", paddingLeft: 7}}>
                                            <View style={{borderWidth: 0.5, borderRadius: 25, height: 40, justifyContent: 'center', paddingLeft: 5, backgroundColor: '#b8b8b8'}}>
                                                <Text>{data.daily_inspection != null ? data.daily_inspection.output_production : "-"}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{paddingTop: 20, flexDirection: 'row'}}>
                                        ...
                                        <View style={{paddingTop: 8, paddingHorizontal: 4, paddingBottom: 4, width: "44%"}}>
                                            <View style={{paddingTop: 5, height: 50, justifyContent: 'center'}}>
                                                <View style={{borderWidth: 0.5, borderRadius: 25, height: 40, justifyContent: 'center', paddingLeft: 5, backgroundColor: '#b8b8b8'}}>
                                                    <Text>{data.daily_inspection != null ? data.daily_inspection.check_appearance_pn : "-"}</Text>
                                                </View>
                                                <View style={{borderWidth: 0.5, borderRadius: 25, height: 40, justifyContent: 'center', paddingLeft: 5, marginTop: 5, backgroundColor: '#b8b8b8'}}>
                                                    <Text>{data.daily_inspection != null ? data.daily_inspection.check_appearance_n : "-"}</Text>
                                                </View>
                                            </View>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{paddingTop: 20, flexDirection: 'row'}}>
                                        ...
                                        <View style={{padding: 4, width: "50%", flexDirection: 'row'}}>
                                            <View style={{width: "50%", alignItems: 'center'}}>
                                                <Text>Start</Text>
                                                <View style={{width: "100%", marginTop: 5, borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 40, backgroundColor: '#b8b8b8'}}>
                                                    <Text style={{marginTop: 5}}>{data.daily_inspection != null ? data.daily_inspection.label_begin : "-"}</Text>
                                                </View>
                                            </View>
                                            <View style={{flex: 1, alignItems: 'center'}}>
                                                <Text>End</Text>
                                                <View style={{width: "100%", marginTop: 5, marginLeft: 2, borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 40, backgroundColor: '#b8b8b8'}}>
