...
import TimeForShift from '../TimeForShift';
				...
				<Container>
					<View style={{flex: 1, height: 100, backgroundColor: '#F5F5DC', borderWidth: 0.3, flexDirection: 'column'}}>
						...
						<View style={{flexDirection: 'row'}}>
							<View style={{borderWidth: 0.3, height: 100, alignItems: 'center', width: "50%", backgroundColor: '#F5F5DC'}}>
								{/* <DATE /> */}
								{date}
						...
						<ScrollView style={{flex: 1}}>
							<View style={{paddingTop: 20, flexDirection: 'row'}}>
								...
								<View style={{padding: 4, width: "50%"}}>
									<TextInput value={tooling} onChangeText={(value) => setTooling(value)} style={{borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 30, width: 177}} placeholder="Type Here..." />
								</View>
							</View>
							<View style={{flexDirection: 'row'}}>
								<View style={{padding: 10, width: "44%"}}>
								...
								<View style={{padding: 4, width: "50%"}}>
									<TextInput keyboardType='numeric' value={cavity} onChangeText={(value) => setCavity(value)} style={{borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 30, width: 177}} placeholder="Type Here..." />
								</View>
							</View>
							<View style={{flexDirection: 'row'}}>
								<View style={{padding: 10, width: "44%"}}>
								...
								<View style={{padding: 4, width: "50%"}}>
									<View style={{borderWidth: 0.5, borderRadius: 25, width: 177, height: 30, justifyContent: 'center', paddingLeft: 5}}>
										<SelectPicker onValueChange={(value) => setCondition(value)} 
											items={[
												{label: "OK", value: "OK"},
												{label: "NG", value: "NG"}
											]}
							...
							<View style={{flexDirection: 'row'}}>
								...
								<View style={{padding: 4, width: "50%"}}>
									<View style={{borderWidth: 0.5, borderRadius: 25, width: 177, height: 30, justifyContent: 'center', paddingLeft: 5}}>
										<SelectPicker onValueChange={(value) => setStandard(value)} 
											items={[
												{label: "OK", value: "OK"},
												{label: "NG", value: "NG"}
											]}
							...
							<View style={{flexDirection: 'row'}}>
								...
								<View style={{padding: 4, width: "50%"}}>
									<TextInput value={remark} onChangeText={(value) => setRemark(value)} style={{borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 30, width: 177}} placeholder="Type Here..." />
								</View>
							</View>
