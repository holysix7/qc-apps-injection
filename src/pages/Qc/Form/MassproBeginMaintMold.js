				...
				<View style={{flex: 1, height: 100, backgroundColor: '#F5F5DC', borderWidth: 0.3, flexDirection: 'column'}}>
					...
					<View style={{paddingTop: 20, flexDirection: 'row'}}>
						...
						<View style={{padding: 4, width: "50%"}}>
							<TextInput style={{borderWidth: 0.5, borderRadius: 25, paddingLeft: 5, height: 30, width: 177}} placeholder="Type Here..." />
						</View>
					</View>
					<View style={{flexDirection: 'row'}}>
						<View style={{padding: 10, width: "44%"}}>
							<Text>Jumlah Cavity</Text>
						</View>
						<View style={{padding: 10, width: "6%", alignItems: 'flex-end'}}>
							<Text style={{color: 'black'}}>:</Text>
						</View>
					...
					<View style={{flexDirection: 'row'}}>
						<View style={{padding: 10, width: "44%"}}>
							<Text>Status dan Kondisi Mold</Text>
						</View>
						<View style={{padding: 10, width: "6%", alignItems: 'flex-end'}}>
							<Text style={{color: 'black'}}>:</Text>
						</View>
