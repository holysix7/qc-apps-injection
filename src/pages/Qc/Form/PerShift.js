                        ...
                        <ScrollView style={{flex: 1}}>
                            ...
                            <View style={{flexDirection: 'row', height: 75, paddingTop: 10}}>
								<View style={{alignItems: 'center', width: "25%"}}>
                                    ...
                                    <View style={{justifyContent: 'center', paddingTop: 23}}>
                                        <SelectPicker onValueChange={(value) => console.log(value)} 
                                            items={[
                                                {label: "OK", value: "OK"},
                                                {label: "NG", value: "NG"}
								...
								<View style={{alignItems: 'center', width: "25%"}}>
									<Text style={{fontWeight: 'bold'}}>Products Weight</Text>
                                        <View style={{justifyContent: 'center'}}>
                                            <TextInput style={{paddingLeft: 5, paddingRight: 5, height: 30}} placeholder="Type Here..." />
                                        </View>
								</View>
								<View style={{alignItems: 'center', width: "25%"}}>
									<Text style={{fontWeight: 'bold'}}>Weight Standard</Text>
                                        <View style={{paddingTop: 7, justifyContent: 'center'}}>
                                            <Text>Auto</Text>
                                        </View>
								</View>
								<View style={{alignItems: 'center', width: "25%"}}>
